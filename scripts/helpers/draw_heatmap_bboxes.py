...
parser.add_argument("--bboxes", type=list, default=[[[ 304, 582, 422, 705 ], [ 304, 582, 422, 705 ], [ 238, 290, 465, 988 ]]], help="bounding boxes")
parser.add_argument("--labels", type=list, default=[[1, 1, 0]])
