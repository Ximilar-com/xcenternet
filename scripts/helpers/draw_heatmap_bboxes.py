...
parser.add_argument("--bboxes", type=list, default=[[[ 304, 582, 422, 705 ], [20, 0, 25, 1], [ 304, 582, 422, 705 ], [ 238, 290, 465, 988 ], [ 38, 290, 665, 988 ], [ 38, 490, 665, 788 ]]], help="bounding boxes")
...
if args.ttf_version:
    heatmap, box_target, reg_weight, _ = draw_heatmaps_ttf(
