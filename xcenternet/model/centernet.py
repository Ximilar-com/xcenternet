...
from xcenternet.model.loss import offset_l1_loss, size_l1_loss, heatmap_focal_loss, giou_loss, solo_loss_category, solo_loss_mask
...
class XTTFSOLOModel(XCenternetModel):
    ...
    def get_loss_funcs(self):
        return {"loss_heatmap": heatmap_focal_loss, "loss_giou": giou_loss, "solo_loss_category": solo_loss_category, "solo_loss_mask": solo_loss_mask}
